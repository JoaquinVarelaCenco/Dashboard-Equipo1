...
jest.mock('../pages/Products/ProductsList/ProductsList', () => () => <div>Fake Product List page</div>)
jest.mock('../pages/Products/ProductView/ProductUpdate', () => () => <div>Fake Product Update page</div>)
jest.mock('../pages/Products/ProductView/ProductCreate', () => () => <div>Fake Product View page</div>)
jest.mock('../pages/NoImplemented/NoImplemented', () => () => <div>Fake NotImplemented page</div>)

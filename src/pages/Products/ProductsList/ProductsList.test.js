...
describe("Test formulario de productos", () => {
  ...
  test("Se debe renderizar correctamente los items", () => {
    const items = screen.getAllByRole("article");
    expect(items.length).toBe(productsData.length);
  });

  test("Seleccion de filtrado predeterminada", () => {
    const optionMasRelevantes = screen.getByRole("option", {
      name: "Mas relevantes",
    }).selected;
    const optionMayorPrecio = screen.getByRole("option", {
      name: "Mayor precio",
    }).selected;
    const optionMenorPrecio = screen.getByRole("option", {
      name: "Menor precio",
    }).selected;
  ...
  test("Seleccion de filtrado por interaccion del usuario por Mayor precio", () => {
  ...
  test("Se deben renderizar los items filtrados por Mayor precio", () => {
    userEvent.selectOptions(
      screen.getByRole("combobox"),
      screen.getByRole("option", { name: "Mayor precio" })
    );
  ...
  test("Seleccion de filtrado por interaccion del usuario por Menor precio", () => {
    userEvent.selectOptions(
      screen.getByRole("combobox"),
  ...
  test("Se deben renderizar los items filtrados por Menor precio", () => {
    userEvent.selectOptions(
      screen.getByRole("combobox"),
      screen.getByRole("option", { name: "Menor precio" })
    );
  ...
  test("Seleccion de filtrado por interaccion del usuario por Mas relevantes", () => {
    userEvent.selectOptions(
      screen.getByRole("combobox"),
  ...
  test("Se deben renderizar los items filtrados por Mas relevantes", () => {
    userEvent.selectOptions(
      screen.getByRole("combobox"),
      screen.getByRole("option", { name: "Mas relevantes" })
    );
  ...
  test("Seleccion de filtrado por interaccion del usuario por A-Z", () => {
    userEvent.selectOptions(
      screen.getByRole("combobox"),
  ...
  test("Se deben renderizar los items filtrados por orden alfabetico de A a la Z", () => {
    userEvent.selectOptions(
      screen.getByRole("combobox"),
      screen.getByRole("option", { name: "A-Z" })
    );
